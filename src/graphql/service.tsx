 ...
 * });
 */
export function useGetContinentQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetContinentQuery,
    GetContinentQueryVariables
  >,
) {
  const options = {...defaultOptions, ...baseOptions};
  return Apollo.useQuery<GetContinentQuery, GetContinentQueryVariables>(
    GetContinentDocument,
    options,
  );
}
export function useGetContinentLazyQuery(
  ...
  const options = {...defaultOptions, ...baseOptions};
  return Apollo.useLazyQuery<GetContinentQuery, GetContinentQueryVariables>(
    GetContinentDocument,
    options,
  );
}
export type GetContinentQueryHookResult = ReturnType<
  typeof useGetContinentQuery
>;
export type GetContinentLazyQueryHookResult = ReturnType<
  typeof useGetContinentLazyQuery
>;
export type GetContinentQueryResult = Apollo.QueryResult<
  GetContinentQuery,
  GetContinentQueryVariables
>;
